    ...
    if all([seq_len == window_size for seq_len in seq_lens]):
        ...
        if ATTN == 'xformers':
            ...
            for seq_len in seq_lens:
                q_i = q[offset:offset + seq_len].permute(1, 0, 2).unsqueeze(0)
                k_i = k[offset:offset + seq_len].permute(1, 0, 2).unsqueeze(0)
                v_i = v[offset:offset + seq_len].permute(1, 0, 2).unsqueeze(0)
                if ATTN == 'sdpa':
