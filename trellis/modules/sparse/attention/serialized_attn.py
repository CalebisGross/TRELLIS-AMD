    ...
    if all([seq_len == window_size for seq_len in seq_lens]):
        ...
        if ATTN == 'xformers':
            ...
            for seq_len in seq_lens:
                q_i = q[offset:offset + seq_len]  # [seq_len, H, C]
                k_i = k[offset:offset + seq_len]
                v_i = v[offset:offset + seq_len]
                # Reshape for attention: [1, H, seq_len, C]
                ...
                if ATTN == 'sdpa':
                    ...
                    attn = attn.softmax(dim=-1)
                    out_i = attn @ v_i
                out_i = out_i.squeeze(0).permute(1, 0, 2)  # [seq_len, H, C]
